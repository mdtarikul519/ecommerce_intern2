                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="title" value="{{ $crud_model->title }}"
                                            class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="">Description</label>
                                        <input type="text" name="Description" value="{{ $crud_model->Description }}"
                                            class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control" name="role">
                                            @foreach ($data as $item)
                                                <option {{ $crud_model->role == $item->id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        @foreach ($hobbies as $item)
                                            <label for="gardining{{ $item->id }}">
                                                <input type="checkbox"
                                                    {{ $crud_model->hobbies->firstwhere('id', '=', $item->id) ? 'checked' : '' }}
                                                    value="{{ $item->id }}" id="gardining{{ $item->id }}"
                                                    name="hobby[]">
                                                {{ $item->title }}
                                            </label>
                                        @endforeach
                                    ...
                                    <div class="form-group mb-3">
                                        <label>Gender::</label>
                                        <label for="male">
                                            <input type="radio" {{ $crud_model->gender == 'male' ? 'checked' : '' }}
                                                value="male" id="male" name="gender">
                                            male
                                        </label>
                                        <label for="female">
                                            <input type="radio" {{ $crud_model->gender == 'female' ? 'checked' : '' }}
                                                value="female" id="female" name="gender">
                                            female
                                        </label>
                                        <label for="others">
                                            <input type="radio" {{ $crud_model->gender == 'others' ? 'checked' : '' }}
                                                value="others" id="others" name="gender">
                                            others
                                        </label>
                                    </div>
                                    ...
                                    @foreach ($hobbies as $item)
                                        <label for="gardining{{ $item->id }}">
                                            <input type="checkbox" value="{{ $item->id }}"
                                                id="gardining{{ $item->id }}" name="hobby[]">
                                            {{ $item->title }}
                                        </label>
                                    @endforeach
                                </div>
                                        ...
                                        @foreach ($all_data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/crud/edit/{{ $item->id }}?edit_form=jj"
