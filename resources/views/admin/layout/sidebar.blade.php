    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        {{-- <li>
            ...
            {{-- </ul>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow" key="t-level-1-2"><i class="bx bx-comment-dots"></i>ExumResult crud</a>
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="{{route('dashboard.exam_result.create')}}" key="t-level-2-1">create</a></li>
                        <li><a href="{{route('dashboard.exam_result.index')}}" key="t-level-2-1">index</a></li>
                    </ul>
                </li>
