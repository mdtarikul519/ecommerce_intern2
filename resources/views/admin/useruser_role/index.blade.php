                ...
                <div class="card">
                    ...
                    <div class="card_body">
                         <div class="col-md-6 ps-4">
                            <form action="{{route('dashboard.useruser_role.user_store')}}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="from-group col-md-6">
                                    <label for="">{{$data->username}}</label>
                                    <input value="{{$data->id}}" type="text" name="user_id" class="form-control" />
