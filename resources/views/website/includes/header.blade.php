...
<!-- Mirrored from htmlbeans.com/html/schon/homepage1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Jan 2023 12:35:04 GMT -->
<head>
  ...
  <link rel="stylesheet" href="{{asset('contents/website/css')}}/animate.css">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="{{asset('contents/website/css')}}/icon-fonts.css">
	<!-- include the site stylesheet -->
...
<body>
	...
	<div id="wrapper">
		...
		<div id="pre-loader" class="loader-container">
			<div class="loader">
				<img src="{{asset('contents/website/images')}}/svg/rings.svg" alt="loader">
			</div>
		</div>
		<!-- W1 start here -->
		<div class="w1">
				...
				<div class="mt-bottom-bar">
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12">
								<!-- mt logo start here -->
								<div class="mt-logo"><a href="#"><img src="{{asset('contents/website/images')}}/mt-logo.png" alt="schon"></a></div>
										...
										<div class="mt-drop">
											...
											<div class="mt-drop-sub">
												...
												<div class="mt-side-widget">
													<!-- cart row start here -->
													<div class="cart-row">
														<a href="#" class="img"><img src="{{asset('contents/website/images')}}/products/img36.jpg" alt="image" class="img-responsive"></a>
														<div class="mt-h">
													...
													<!-- cart row start here -->
													<div class="cart-row">
														<a href="#" class="img"><img src="{{asset('contents/website/images')}}/products/img37.jpg" alt="image" class="img-responsive"></a>
														<div class="mt-h">
															<span class="mt-h-title"><a href="#">Marvelous Modern 3 Seater</a></span>
															<span class="price"><i class="fa fa-eur" aria-hidden="true"></i> 599,00</span>
														</div>
													...
													<!-- cart row start here -->
													<div class="cart-row">
														<a href="#" class="img"><img src="{{asset('contents/website/images')}}/products/img38.jpg" alt="image" class="img-responsive"></a>
														<div class="mt-h">
															<span class="mt-h-title"><a href="#">Marvelous Modern 3 Seater</a></span>
															<span class="price"><i class="fa fa-eur" aria-hidden="true"></i> 599,00</span>
														</div>
													...
													<div class="mt-f-box">
														...
														<div class="mt-col-3 promo">
															<div class="mt-promobox">
																<a href="#"><img src="{{asset('contents/website/images')}}/banner-drop.jpg" alt="promo banner" class="img-responsive"></a>
															</div>
														</div>
														<!-- mt col3 end here -->
													</div>
